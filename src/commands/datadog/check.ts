...
export interface DataDogCheckOptions {
  verbose?: boolean;
}

/**
 * Check DataDog connection by sending a test log
 * Verifies that DataDog is configured and can receive logs
 */
export async function dataDogCheck(options: DataDogCheckOptions = {}): Promise<void> {
